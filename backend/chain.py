...
# В процессе развертывания модели в Yandex Cloud мы столкнулись с рядом технических сложностей,
# связанных с особенностями самой платформы.

# Мы обратились в службу поддержки Яндекса для решения проблем с развертыванием,
# однако, к сожалению, не получили своевременного ответа.

# В связи с этим было принято решение использовать альтернативный облачный сервис,
# предоставляющий доступ к open-source модели через API.
